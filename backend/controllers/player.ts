...
const staticPlayerIdsByPosition: Record<string, number[]> = {
  GK: [33, 61, 83, 84, 85, 129, 139, 141, 190, 193, 255, 522, 7984],
  LB: [30, 88, 112, 124, 135, 142, 152, 218, 284, 483, 7985],
  CB: [11, 13, 15, 121, 122, 123, 162, 485, 487, 2243, 2451, 3999, 6823],
  RB: [10, 20, 28, 185, 187, 256, 266, 274, 393, 881, 4999, 7000, 8982],
  CM: [3, 4, 7, 8, 43, 44, 98, 100, 382, 523, 2882, 2888, 2899, 5981, 6990, 7983],
  LW: [26, 90, 101, 109, 110, 126, 237, 244, 383, 5992],
  RW: [5, 34, 87, 91, 92, 188, 245, 325, 329, 521, 2887, 6986],
  ST: [1, 2, 6, 42, 47, 50, 67, 86, 324, 338, 340, 524, 7981, 7982],
};
